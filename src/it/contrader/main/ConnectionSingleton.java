 ...
 * Nello specifico implementa � fornisce un metodo sicuro ed efficace per la connessione con il nostro database
 */

public class ConnectionSingleton {

	/*
	 * private : indica una funzione/variabile il cui scope ( ovvero visibilit� ) � delineato all'interno della classe in cui
	 * viene creato.
	 * static : indica che il valore della variabile in questione � unico per tutte le instanze della classe
